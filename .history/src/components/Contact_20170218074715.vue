<template>
  ...
  <md-theme md-name="purple">
   ...
   <md-card class="md-primary" md-theme="blue" md-with-hover>
      <md-card-media>
        <img src="http://vignette2.wikia.nocookie.net/fictional-battle-omniverse/images/3/37/Negan_The_Walking_Dead_TV_Series.png/revision/latest/window-crop/width/200/x-offset/0/y-offset/51/window-width/770/window-height/385?cb=20160408143122" alt="People">
      </md-card-media>
